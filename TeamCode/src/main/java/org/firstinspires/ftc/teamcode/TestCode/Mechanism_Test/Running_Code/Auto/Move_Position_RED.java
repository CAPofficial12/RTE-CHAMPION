...
@Autonomous(name = "Move Autonomous RED")
public class Move_Position_RED extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(46, 81));
    }
    ...
    public void start() {
        ...
        forwards = new Path(new BezierLine(follower.getPose(), new Pose(39,100)));
        forwards.setLinearHeadingInterpolation(follower.getHeading(), Math.toRadians(127));
